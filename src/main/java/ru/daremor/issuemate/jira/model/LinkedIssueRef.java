...
public class LinkedIssueRef {
    ...
    @JsonProperty @Schema(description = "Key") String key;
    @JsonProperty @Schema(description = "Summary (if provided)") String summary;
    @JsonProperty @Schema(description = "Status name (if provided)") String statusName;
}
